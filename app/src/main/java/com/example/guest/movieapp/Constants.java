...
public class Constants {
    public static final String MOVIE_KEY = BuildConfig.API_KEY;
    public static final String MOVIE_KEY_QUERY_PARAMETER = "api_key";
    public static final String MOVIE_LANGUAGE_QUERY_PARAMETER = "language";
